<script setup>
import { Bot, FileStack, LoaderCircle, Package, PackageOpen, RefreshCw, Tags } from "@lucide/vue";
    ...
    <main id="main-content" class="admin-main">
      <header class="admin-heading">
        ...
        <nav aria-label="管理工具">
          ...
          <RouterLink :to="{ name: 'admin-skills' }"><Package :size="16" />Skill 管理</RouterLink>
