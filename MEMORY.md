...
- worker 一律用 **glm-5.3**（pi profile，contest-qwen provider；即用户说的 glm5.3flash）；codex/gpt-5.6-sol 仅咨询用，其端点（150.158.82.70:8080 /responses）不稳，502 时勿重试会话，直接换 kimi 审核。
