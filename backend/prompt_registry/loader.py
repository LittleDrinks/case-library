...
PRODUCT_PROMPTS_DIR = Path(__file__).resolve().parents[2] / "product_prompts"
RUNTIME_PROMPTS_DIR = PRODUCT_PROMPTS_DIR / "runtime"
...
def prompt_from_runtime_assets(
    *,
    ...
    """Create a Prompt whose runtime bodies are loaded from product_prompts/runtime."""
